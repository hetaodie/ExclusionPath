...
@interface SimplePageVC ()

@end

@implementation SimplePageVC
...
-(void)pagingWithTextKit
{
    ...
    // 1.读取文件中的文本
    NSString *textString = [[NSString alloc]initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"测试" ofType:@"txt"] encoding:NSUTF8StringEncoding error:nil];
